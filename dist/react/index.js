...
var f = class {
	...
	constructor(e) {
		...
		let i = this.selectEl.getAttribute("aria-label"), a = this.selectEl.getAttribute("aria-labelledby"), s = [
			this.render.main.main,
			this.render.content.search.input,
			this.render.content.list
		];
		if (i) for (let e of s) e.removeAttribute("aria-labelledby"), e.setAttribute("aria-label", i);
		else if (a) for (let e of s) e.removeAttribute("aria-label"), e.setAttribute("aria-labelledby", a);
			...
			for (let t of s) t.removeAttribute("aria-label"), t.setAttribute("aria-labelledby", e.join(" "));
		}
